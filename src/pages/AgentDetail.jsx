...
import { APPS, AGENT_RESPONSES } from '../data/registry';
import { AGENT_ICONS, IconChevLeft, IconSend, IconCheck } from '../components/Icons';
...
export default function AgentDetail() {
  ...
  const send = () => {
    ...
    setInput('');
    setTimeout(() => {
      setMessages(prev => [...prev, { from: 'bot', text: AGENT_RESPONSES[app.id] || 'Processing your request…' }]);
    }, 1000);
  };
