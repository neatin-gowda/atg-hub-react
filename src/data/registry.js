...
export const AI_AGENTS = [
  { id:'hr-voice', name:'MYHR AI Agent', icon:'voice', type:'voice', status:'live', tags:['AI-powered','Live'], desc:'Policies, benefits, leave & payroll support', tagline:'Chat or call for instant help with HR policies, benefits, leave, and more.', img:'/assets/images/agents/hero-hr-voice.jpg', features:[{t:'Company policies',d:'WFH, WFA, dress code, working hours.'},{t:'Benefits & insurance',d:'Medical, dental, vision, dependants.'},{t:'Leave balances',d:'Annual, sick, personal leave.'},{t:'Payroll queries',d:'Salary status, pay slips.'},{t:'Onboarding help',d:'New joiner setup, buddy program.'},{t:'Workplace support',d:'Grievance, EAP referrals.'}], api:'POST /api/agents/hr-voice/chat', payload:'{ "message": "..." }' },
  { id:'finops-agent', name:'FinOps AI Agent', icon:'finops', type:'agent', status:'live', tags:['AI-powered','Live'], desc:'Cloud cost, utilisation & spend prediction', tagline:'AI-powered cloud financial management — Azure, AWS cost analysis.', img:'/assets/images/agents/hero-finops.jpg', features:[{t:'Azure cost analysis',d:'Real-time spend by subscription.'},{t:'AWS cost tracking',d:'Cross-cloud cost comparison.'},{t:'Token utilisation',d:'AI/LLM token tracking.'},{t:'Cost prediction',d:'ML-based forecasting.'},{t:'Optimisation tips',d:'Right-sizing, reserved instances.'},{t:'Budget alerts',d:'Proactive spend notifications.'}], api:'POST /api/agents/finops/query', payload:'{ "query": "Azure spend?" }' },
  { id:'contract-agent', name:'Contract AI Agent', icon:'contract', type:'agent', status:'live', tags:['AI-powered','Live'], desc:'Review, summarise, extract clauses', tagline:'Upload contracts. Get summaries, risk flags, clause extraction.', img:'/assets/images/agents/hero-contract.jpg', features:[{t:'Summary',d:'1-page summary in seconds.'},{t:'Clause extraction',d:'Termination, liability, IP.'},{t:'Risk scoring',d:'AI flags high-risk terms.'}], api:'POST /api/agents/contract/analyze', payload:'{ "action": "summarize" }' },
  { id:'it-agent', name:'IT Service Desk Agent', icon:'it', type:'agent', status:'live', tags:['AI-powered','Live'], desc:'Resolve IT issues, passwords, access', tagline:'AI-first IT support — resolves 80% of tickets automatically.', img:'/assets/images/agents/hero-it.jpg', features:[{t:'Password reset',d:'Self-service with MFA.'},{t:'Access requests',d:'Auto-routed approval.'},{t:'Troubleshooting',d:'VPN, email, printer fixes.'}], api:'POST /api/agents/it/ticket', payload:'{ "issue": "VPN not connecting" }' },
  { id:'finance-agent', name:'Finance AI Agent', icon:'finance', type:'agent', status:'beta', tags:['AI-powered','Beta'], desc:'Expenses, budgets, invoices', tagline:'Ask about budgets, expenses, invoices — no spreadsheets.', img:'/assets/images/agents/hero-finance.jpg', features:[{t:'Expense lookup',d:'Reimbursement status.'},{t:'Budget dashboard',d:'Spend vs budget.'},{t:'Invoice tracker',d:'End-to-end tracking.'}], api:'POST /api/agents/finance/query', payload:'{ "query": "Budget remaining?" }' },
  { id:'knowledge-base', name:'Knowledge Base', icon:'knowledge', type:'agent', status:'live', tags:['AI-powered','Live'], desc:'AI search across all docs', tagline:'One search across every doc — powered by AI.', img:'/assets/images/agents/hero-knowledge.jpg', features:[{t:'Semantic search',d:'Questions, not keywords.'},{t:'Citations',d:'Cites the source.'},{t:'Multi-source',d:'SharePoint, Confluence, Drive.'}], api:'POST /api/agents/knowledge/search', payload:'{ "query": "GDPR?" }' },
];

export const HR_APPS = [
  { id:'leave-mgmt', name:'Leave Management', icon:'leave', type:'hr', status:'live', tags:['HR','Live'], desc:'Apply, track & approve leave requests', tagline:'Complete leave management — balances, requests, approvals.', img:'/assets/images/hr/hero-leave.jpg', features:[{t:'Leave balance',d:'Real-time PTO, sick, annual balances.'},{t:'Apply leave',d:'Submit requests with type and dates.'},{t:'Manager approvals',d:'Approve or decline team requests.'}], api:'GET /api/hr/leave', payload:'{ "userId": "..." }' },
  { id:'salary-status', name:'Salary & Payroll', icon:'salary', type:'hr', status:'live', tags:['HR','Live'], desc:'Payroll status, pay slips & tax docs', tagline:'Track salary processing, download pay slips, access tax documents.', img:'/assets/images/hr/hero-salary.jpg', features:[{t:'Salary status',d:'Monthly processing updates.'},{t:'Pay slips',d:'Download current and past slips.'},{t:'Tax documents',d:'Annual tax certificates.'}], api:'GET /api/hr/salary', payload:'{ "userId": "..." }' },
  { id:'benefits-portal', name:'Benefits Portal', icon:'benefits', type:'hr', status:'live', tags:['HR','Live'], desc:'Medical, dental, insurance & claims', tagline:'Manage your benefits — insurance cards, claims, dependants.', img:'/assets/images/hr/hero-benefits.jpg', features:[{t:'Insurance cards',d:'View and share your medical cards.'},{t:'Submit claims',d:'Upload receipts, track reimbursements.'},{t:'Dependants',d:'Add or update family members.'}], api:'GET /api/hr/benefits', payload:'{ "userId": "..." }' },
  { id:'employee-handbook', name:'Employee Handbook', icon:'handbook', type:'hr', status:'live', tags:['HR','Live'], desc:'Policies, code of conduct & guidelines', tagline:'All company policies and guidelines in one place.', img:'/assets/images/hr/hero-handbook.jpg', features:[{t:'Policies',d:'WFH, WFA, dress code, working hours.'},{t:'Code of conduct',d:'Ethics, compliance, reporting.'},{t:'Guidelines',d:'Travel, expenses, IT security.'}], api:'GET /api/hr/handbook', payload:'{}' },
];

export const INTERNAL_APPS = [
  { id:'onboarding', name:'Onboarding Portal', icon:'onboard', type:'app', status:'live', tags:['Internal','Live'], desc:'New joiner checklist & guides', tagline:'Everything a new joiner needs.', img:'/assets/images/apps/hero-onboarding.jpg', features:[{t:'Checklist',d:'Step-by-step setup.'},{t:'Buddy matching',d:'Auto-paired 30 days.'},{t:'Calendar',d:'Pre-populated schedule.'}], api:'GET /api/apps/onboarding/checklist', payload:'{ "userId": "..." }' },
  { id:'data-platform', name:'Data & Analytics', icon:'data', type:'app', status:'live', tags:['Internal','Live'], desc:'Self-service dashboards', tagline:'Build dashboards without SQL.', img:'/assets/images/apps/hero-data.jpg', features:[{t:'Drag-and-drop',d:'Chart builder.'},{t:'Data catalogue',d:'Browse datasets.'},{t:'Reports',d:'Auto-email.'}], api:'GET /api/apps/data/dashboards', payload:'{ "teamId": "..." }' },
  { id:'recognition', name:'Peer Recognition', icon:'kudos', type:'app', status:'live', tags:['Engagement','Live'], desc:'Kudos, points, rewards', tagline:'Recognition that feels real.', img:'/assets/images/apps/hero-recognition.jpg', features:[{t:'Kudos',d:'Recognise anyone.'},{t:'Marketplace',d:'Redeem rewards.'},{t:'Leaderboards',d:'Rankings.'}], api:'POST /api/kudos', payload:'{ "recipient": "...", "message": "..." }' },
  { id:'learning-hub', name:'Learning Hub', icon:'learning', type:'app', status:'live', tags:['Internal','Live'], desc:'Courses, certifications & training', tagline:'LinkedIn Learning, Coursera, and internal masterclasses.', img:'/assets/images/apps/hero-learning.jpg', features:[{t:'Course library',d:'Browse available courses.'},{t:'Certifications',d:'Track progress and badges.'},{t:'Budget',d:'AED 8,000 annual allocation.'}], api:'GET /api/apps/learning', payload:'{ "userId": "..." }' },
];
