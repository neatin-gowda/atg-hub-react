...
export const AI_AGENTS = [
  { id:'hr-voice', name:'Talk to ATLAS', icon:'voice', type:'voice', status:'live', tags:['AI-powered','Live'], desc:'Voice orchestration across apps and agents', tagline:'Ask ATLAS to answer, navigate, act, or hand off to specialist agents.', img:'/assets/images/hero/carousel-5-hr-agent.jpg', features:[{t:'Voice orchestration',d:'Speak to navigate and work across ATLAS.'},{t:'MyHR handoff',d:'Transfer HR policy, leave, payroll, and benefits questions.'},{t:'App navigation',d:'Open Leave, Kudos, Profile, Apps, and agent areas.'},{t:'Action drafting',d:'Prepare safe next steps before posting or submitting.'},{t:'Context aware',d:'Reads only the relevant app surface before answering.'},{t:'Reusable agents',d:'Routes to HR, IT, Finance, Knowledge, and engagement agents.'}], api:'POST /api/agents/hr-voice/chat', payload:'{ "message": "..." }' },
